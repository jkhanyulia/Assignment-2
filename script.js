...
initFormValidation = () => {
  ...
  // making sure that it's actually the form page
  // prevents errors appearing by trying to run this function on other pages
  if (form) {
    form.addEventListener("submit", (e) => {
      ...
      // clearing the success/error styling
...
renderDesserts = () => {
  ...
  if (menu) {
    ...
    desserts.forEach(dessert => {
      ...
      card.setAttribute("dessert-filter", dessert.filter);
...
initFiltering = () => {
  ...
  if (filterList) {
    ...
    filterButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        let dessertCategory = e.target.getAttribute("dessert-filter");
  ...
  function filterDesserts(filter) {
    ...
    cards.forEach((card) => {
      const category = card.getAttribute("dessert-filter");
